...
class AccountChooseBankPage extends StatefulWidget {
  static const String path = '/index/account/choose-bank';

  @override
  _AccountChooseBankPageState createState() => _AccountChooseBankPageState();
}

class _AccountChooseBankPageState extends State<AccountChooseBankPage> {
  @override
  ...
  void onBankCardTapped() {
    Navigator.of(context).pushNamed(AccountBankInformationPage.path);
  }
}

class _AccountChooseBankView
    extends WidgetView<AccountChooseBankPage, _AccountChooseBankPageState> {
  _AccountChooseBankView(_AccountChooseBankPageState state) : super(state);
