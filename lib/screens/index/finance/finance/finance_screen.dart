...
class _FinanceScreenState extends State<FinanceScreen>
  ...
  Widget build(BuildContext context) {
    return _FinanceScreenView(this);
  }
...
class _FinanceScreenView
    extends WidgetView<FinanceScreen, _FinanceScreenState> {
  _FinanceScreenView(_FinanceScreenState state) : super(state);
