...
class BudgetExpenseAmountScreen extends StatefulWidget {
  ...
  _BudgetExpenseAmountScreenState createState() =>
      _BudgetExpenseAmountScreenState();
}

class _BudgetExpenseAmountScreenState extends State<BudgetExpenseAmountScreen> {
  @override
  Widget build(BuildContext context) {
    return _BudgetExpenseAmountView(this);
  }
...
class _BudgetExpenseAmountView extends WidgetView<BudgetExpenseAmountScreen,
    _BudgetExpenseAmountScreenState> {
  _BudgetExpenseAmountView(_BudgetExpenseAmountScreenState state)
      : super(state);
