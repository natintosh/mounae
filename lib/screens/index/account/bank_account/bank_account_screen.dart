...
class AccountBankAccountScreen extends StatefulWidget {
  static const String path = '/index/account/bank-account';

  @override
  _AccountBankAccountScreenState createState() =>
      _AccountBankAccountScreenState();
}

class _AccountBankAccountScreenState extends State<AccountBankAccountScreen> {
  @override
...
class _AccountBankAccountView extends WidgetView<AccountBankAccountScreen,
    _AccountBankAccountScreenState> {
  _AccountBankAccountView(_AccountBankAccountScreenState state) : super(state);
